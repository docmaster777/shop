...
<!--                            <li><a href="#"><i class="fa fa-phone"></i> +7 9272 044 233 Дмитрий</a></li>-->
<!--                            <li><a href="#"><i class="fa fa-envelope"></i> vin121@bk.ru</a></li>-->
<!--                        </ul>-->
<!--                    </div>-->
<!--                </div>-->
<!--                <div class="col-sm-6">-->
...
<!--                                    <li><a href="#retail">Розничная торговля</a></li>-->
<!--                                    <li><a href="contact-us.html">Контакты</a></li>-->
<!--                                    <li><a href="contact-us.html">Магазин</a></li>-->
<!--                                </ul>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--        </div>-->
            ...
            <div class="cbp-af-header">
                <div class="cbp-af-inner">
                    <a href="/"><h1>Bags&Hats</h1></a>
                    <nav>
                        <a href="#wholesale">Оптовая торговля</a>
                        <a href="#retail">Розничная торговля</a>
                        <a href="#about">О нас</a>
                        <a href="/category/index">Магазин</a>
                    </nav>
                </div>
            </div>
        </div>
